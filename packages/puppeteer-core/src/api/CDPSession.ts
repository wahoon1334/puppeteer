...
const Disconnected = Symbol('CDPSession.Disconnected');
const Swapped = Symbol('CDPSession.Swapped');
const Ready = Symbol('CDPSession.Ready');
/**
 * Events that the CDPSession class emits.
 *
 * @public
 */
export const CDPSessionEvent = {
  /**
   * @internal
   */
  Disconnected,
